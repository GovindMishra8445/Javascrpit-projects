...
function showSelectedOperator(){
    ...
    for (var i=0; i<elements.length; i++){
        elements[i].style.backgroundColor  = "#1c1813";
    }

    if (operator_value == "+"){
        document.getElementById("plusOp").style.backgroundColor  = "#111";
    }
    else if (operator_value == "-"){
        document.getElementById("subOp").style.backgroundColor  = "#111";
    }
    else if (operator_value == "*"){
        document.getElementById("multiOp").style.backgroundColor  = "#111";
    }
    else if (operator_value == "/"){
        document.getElementById("divOp").style.backgroundColor  = "#111";
    }
}
...
function keyReleased(e){
    ...
    if (e.key == "Backspace"){
        document.getElementById("backspace_btn").style.backgroundColor  = "#111";
    }
}